...
func proxyRepeatHandler(w http.ResponseWriter, r *http.Request) {
	...
	if body.ID == "" {
		httputil.JSONError(w, "missing id", 400)
		return
	}
	...
	if original == nil {
		httputil.JSONError(w, "entry not found: "+body.ID, 404)
		return
	}
	...
	if err != nil {
		httputil.JSONError(w, "failed to create request: "+err.Error(), 500)
		return
	}
	...
	if err != nil {
		httputil.JSONError(w, "request failed: "+err.Error(), 502)
		return
	}
