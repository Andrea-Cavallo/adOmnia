// All monospace fonts below (except cascadia-code) are bundled via @fontsource.
// cascadia-code is a Windows system font (ships with Windows Terminal / Win 11).
export const UI_FONTS = [
  ...
  { id: 'inter',            label: 'Inter (sans-serif)', stack: "'Inter', 'IBM Plex Sans', 'Segoe UI', system-ui, sans-serif" },
  { id: 'geist',            label: 'Geist (sans-serif)', stack: "'Geist', 'Inter', system-ui, sans-serif" },
] as const
