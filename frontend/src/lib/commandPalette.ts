...
export const COMMAND_PALETTE_PANELS: PalettePanel[] = [
  ...
  { id: 'broker', title: 'Broker Studio', group: 'Protocols', keywords: 'mqtt amqp messaging' },
  ...
  { id: 'kafka', title: 'Kafka Client', group: 'Protocols', keywords: 'topic producer consumer broker load test' },
  ...
  { id: 'templates', title: 'Templates', group: 'Data', keywords: 'marketplace snippets presets' },
