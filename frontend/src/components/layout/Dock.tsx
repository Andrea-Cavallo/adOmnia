...
const DOCK_ITEMS: DockItemDef[] = [
  ...
  { id: 'runner',      icon: Play,           label: 'Runner',           color: '#60a5fa' },
  { id: 'flows',       icon: GitBranch,      label: 'Flows',            color: '#c084fc' },
  { id: 'matrix',      icon: Network,        label: 'Env Matrix',       color: '#2dd4bf' },
  ...
  { id: 'templates',   icon: LayoutTemplate, label: 'Templates',        color: '#818cf8' },
