...
const HUB_LAYERS: Array<Omit<HubLayer, 'stats'>> = [
  {
    ...
    accent: '#b794ff',
    desc: 'Everything that speaks over the wire. Compose requests, inspect frames and work with REST, SOAP, gRPC, MCP and streaming from one desktop surface.',
    ...
    tools: [
      ...
      { id: 'mcp', icon: Network, title: 'MCP Client', desc: 'Connect to MCP servers, inspect tools, resources and prompts, then generate local MCP servers from collections.', foot: 'AI protocol' },
  ...
  },
  {
    ...
    index: 'L2 / 08',
    title: 'Logic',
    tag: 'design / route / simulate / verify',
    accent: '#6ee7b7',
    desc: 'The behavioural middle. Design API contracts, route messages, mock services you do not have yet, run suites, schedule jobs and generate realistic data.',
    flow: ['input', 'simulate', 'assert', 'report'],
    tools: [
      { id: 'apieditor', icon: Code2, title: 'API Editor', desc: 'Create and maintain OpenAPI operations with parameters, request bodies and response schemas.', foot: 'spec-first' },
      ...
      { id: 'visualtests', icon: ListChecks, title: 'Visual Tests', desc: 'Build request-level test scenarios visually and export them into flow definitions.', foot: 'no-code checks' },
      { id: 'scheduler', icon: CalendarClock, title: 'Scheduled Tasks', desc: 'Run local API jobs on an interval with persisted status and execution history.', foot: 'automation' },
    ],
  },
  {
    id: 'storage',
    ...
    accent: '#5eead4',
    desc: 'Where things rest. Browse databases, manage schemas, encrypt secrets, inspect local storage and keep complete workspaces exportable as files.',
    ...
    tools: [
      ...
      { id: 'schemas', icon: Boxes, title: 'Schema Components', desc: 'Maintain reusable JSON Schema models and inject them into OpenAPI exports.', foot: 'contract models' },
      ...
      { id: 'markdown', icon: FileText, title: 'Document Studio', desc: 'Markdown notes, Mermaid diagrams, LaTeX CV presets and local PDF editing/signing in one hub.', foot: 'docs nearby' },
    ],
  },
  {
    id: 'observability',
