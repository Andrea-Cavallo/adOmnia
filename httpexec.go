...
// ExecuteHTTP executes an HTTP request via Go's net/http, bypassing all browser
// CORS / header / redirect / TLS restrictions. It is the backend counterpart of
// the old browser-fetch path in sendRequest.ts.
