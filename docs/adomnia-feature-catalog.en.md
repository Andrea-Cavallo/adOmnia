...
Bug Hunt v0.9.14 adds dash refills on direct hits, 17 enemies including optional aerial chains, a six-bit/eight-second Bonus Rush per stage, S/A/B/C score ranks and a final double-wave boss phase. Canvas framing keeps the whole level visible.
